# Orthos Read-Only Dashboard For Birdmug

This dashboard is for Kyle to monitor Orthos interface activity without admin controls.
...
```bat
cd /d C:\LLM\orthos-readonly-dashboard

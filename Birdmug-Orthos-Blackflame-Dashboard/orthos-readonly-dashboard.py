...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    h1 { margin:0; font-size:22px; font-weight:700; color:#fff7dc; text-shadow:0 0 4px rgba(255, 240, 170, .38), 0 0 10px rgba(255, 96, 0, .58), 0 0 22px rgba(255, 32, 8, .34), 0 0 38px rgba(255, 150, 0, .18); animation:blackflame-flicker 4.8s infinite alternate ease-in-out; }
    @keyframes blackflame-flicker {
      0% { color:#fff8df; text-shadow:0 0 3px rgba(255, 245, 180, .32), 0 0 9px rgba(255, 96, 0, .42), 0 0 20px rgba(255, 32, 8, .25), 0 0 32px rgba(255, 150, 0, .12); }
      28% { color:#fff4c6; text-shadow:0 0 4px rgba(255, 245, 180, .42), 0 0 11px rgba(255, 106, 0, .55), 0 0 24px rgba(255, 35, 8, .32), 0 0 40px rgba(255, 150, 0, .18); }
      57% { color:#fff9e8; text-shadow:0 0 3px rgba(255, 245, 180, .28), 0 0 8px rgba(255, 85, 0, .38), 0 0 18px rgba(255, 30, 8, .24), 0 0 34px rgba(255, 130, 0, .14); }

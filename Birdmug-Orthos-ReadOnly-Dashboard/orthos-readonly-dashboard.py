...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    button { border:1px solid #1d8d69; background:#15392f; color:var(--text); border-radius:6px; padding:10px 13px; cursor:pointer; font-weight:650; }
    button:hover { background:#1b493b; }
    ...
    .check { border:1px solid var(--line); background:#151920; border-radius:6px; padding:9px 10px; min-height:64px; }
    .check.ok { border-color:#1d8d69; background:#143128; }
    .check.fail { border-color:#9a3038; background:#351a20; }
    ...
    .counter-card { border:1px solid var(--line); background:#151920; border-radius:6px; padding:9px; min-height:64px; }
    ...
    .counter-tabs button { border-color:var(--line); background:#242a33; padding:6px 9px; font-size:12px; }
    .counter-tabs button.active { border-color:var(--blue); color:#cfe1ff; background:#18304f; }
    .meter { height:8px; border-radius:999px; background:#101318; border:1px solid var(--line); overflow:hidden; margin-top:10px; }
    .meter > div { height:100%; background:linear-gradient(90deg, var(--good), var(--blue)); width:0%; }
    ...
    .status-ok { background:#15392f; color:#b6ffe8; border-color:#1d8d69; }
    .status-503, .status-429 { background:#5a1f28; color:#ffd5da; border-color:#a63b48; }
    .status-error { background:#4f3818; color:#ffe2a8; border-color:#9f742b; }
    tr.row-blocked td { background:rgba(255, 95, 109, .10); color:#ffd5da; }
    tr.row-error td { background:rgba(241, 184, 75, .10); color:#ffe2a8; }
    code { color:#c8ddff; }
